...
def display_visualizations(dataset, title_suffix=""):
    ...
    # Debugging: Print first few rows of fips_revenue to check data
    st.write(fips_revenue.head())
    ...
    fig_fips = px.choropleth(
        ...
        locations="FIPS Code",
        color="Revenue",
        color_continuous_scale="Viridis",  # Try other scales like 'Blues', 'Inferno', etc.
        scope="usa",
